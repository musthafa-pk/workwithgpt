...
//                                           setState(() {
//                                             Utils.selectedDropLatitude =
//                                                 double.parse(selectedAddress[
//                                                     'latitude']);
//                                             Utils.selectedDropLongitude =
//                                                 double.parse(selectedAddress[
//                                                     'longitude']);
//                                             Utils.orderdetails.add({
//                                               'from': Utils.FromAddress[0]
//                                                   ['address_label'],
...
//                                                                   .toString();
//                                                           print(
//                                                               'priceby item in slide ${subSlide['price']}');
//                                                         });
//                                                       },
//                                                       child: Container(
//                                                         decoration: BoxDecoration(
...
//                                                               Utils.totalPrice;
//                                                           print(
//                                                               'tootal price:${subSlide['priceBycount']}');
//                                                           // Utils.totalPrice = subSlide['price'] * int.parse(subSlide['count']);
//                                                           print(
//                                                               'Total price: ${Utils.totalPrice}');
//                                                           setState(() {});
//                                                         });
//                                                       },
//                                                     ),
...
//                                               ),
//                                               Text(
//                                                 subSlide['priceBycount'] == null
//                                                     ? '0'
//                                                     : subSlide['priceBycount']
//                                                         .toString(),
//                                                 style: TextStyle(
//                                                   fontWeight: FontWeight.bold,
//                                                   fontSize: 18,
...
//                                                   });
//                                                   void findsubSlidetotalprice(){
//                                                     for(int i=0;i<=subSlide.length;i++){
//                                                       setState(() {
//                                                         Utils.totalPrice =(Utils.totalPrice! + int.parse(subSlide[i]['cost']!));
//                                                         print(Utils.totalPrice);
//                                                       });
//                                                     }
//                                                     print('loopppp${Utils.totalPrice}');
//                                                   }
//                                                   print('product list');
